...
int main()
{
...

	{
		...
		XmlTest ( "Root element value is 'LineStationDesiginProfile'.", "LineStationDesiginProfile",  node->Value());
		...
		node = doc.FirstChild( "LineStationDesiginProfile" );
		assert( node );
		...
		node = node->FirstChild();
		XmlTest( "First child exists & is a element.", true, ( node != 0 && node->ToElement() ) );
		printf("== first child: %s\n",node->Value());
		node = node->NextSibling();
		XmlTest( "Sibling element exists & is an element.", true, ( node != 0 && node->ToElement() ) );
		printf("== Sibling element: %s\n",node->Value());
		XmlTest ( "Value is 'PluginName'.", "PluginName", node->Value() );

		node = node->NextSibling();
		XmlTest( "Sibling element exists & is an element.", true, ( node != 0 && node->ToElement() ) );
		printf("== Sibling element: %s\n",node->Value());
		XmlTest ( "Value is 'Version'.", "Version", node->Value() );

		node = node->NextSibling();
		XmlTest( "Sibling element exists & is an element.", true, ( node != 0 && node->ToElement() ) );
		printf("== Sibling element: %s\n",node->Value());
		XmlTest ( "Value is 'Enable'.", "Enable", node->Value() );


		node = node->NextSibling();
		XmlTest( "Sibling element exists & is an element.", true, ( node != 0 && node->ToElement() ) );
		printf("== Sibling element: %s\n",node->Value());
		XmlTest ( "Value is 'AutoLoaded'.", "AutoLoaded", node->Value() );
		

		node = node->NextSibling();
		XmlTest( "Sibling element exists & is an element.", true, ( node != 0 && node->ToElement() ) );
		printf("== Sibling element: %s\n",node->Value());
		XmlTest ( "Value is 'LineSections'.", "LineSections", node->Value() );

		node = node->FirstChild();
		XmlTest ( "First child exists.", true, ( node != 0 && node->ToElement() ) );
		XmlTest ( "Value is 'LineSection'.", "LineSection", node->Value() );
